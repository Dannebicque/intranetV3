    ...
    success: function (data){
      ...
      jQuery.each(data, function(index, etudiant) {
        var html = "<div class=\"col-sm-6 col-md-3 col-lg-3\">\n" +
          ...
          "                    <a class=\"dropdown-item\" href=\""+Routing.generate('user_profil', {type: 'etudiant', slug: etudiant.slug})+"\"><i class=\"fa fa-user\"></i> Profil</a>\n" +
          ...
          "            <a href=\""+Routing.generate('user_profil', {type: 'etudiant', slug: etudiant.slug})+"\">\n" +
          "                <img class=\"avatar avatar-xxl\" src=\"\">\n" +
          "            </a>\n" +
          "            <h5 class=\"mt-3 mb-1\">\n" +
          "                <a class=\"hover-primary\" href=\""+Routing.generate('user_profil', {type: 'etudiant', slug: etudiant.slug})+"\">"+etudiant.prenom+" " + etudiant.nom+"\n" +
          "                </a>\n" +
          "            </h5>\n" +
          "        </div>\n" +
          "    </div>\n" +
