    ...
    1: [function (require, module, exports) {
        ...
        _createClass(Permission, [{
          ...
          value: function _requestAsPromise() {
            ...
            var s = i !== this.DEFAULT,
              ...
              n = this._win.webkitNotifications && this._win.webkitNotifications.checkPermission;
          ...
          value: function get() {
            var i = void 0;
            return i = this._win.Notification && this._win.Notification.permission ? this._win.Notification.permission : this._win.webkitNotifications && this._win.webkitNotifications.checkPermission ? this._permissions[this._win.webkitNotifications.checkPermission()] : navigator.mozNotification ? this.GRANTED : this._win.external && this._win.external.msIsSiteMode ? this._win.external.msIsSiteMode() ? this.GRANTED : this.DEFAULT : this.GRANTED;
          }
        }]);
      ...
      var Push = function () {
        function Push(t) {
          ...
          this._currentId = 0, this._notifications = {}, this._win = t, this.Permission = new _Permission2.default(t), this._agents = {
            desktop: new _DesktopAgent2.default(t),
            chrome: new _MobileChromeAgent2.default(t),
            firefox: new _MobileFirefoxAgent2.default(t),
            ms: new _MSAgent2.default(t),
            webkit: new _WebKitAgent2.default(t)
          }, this._configuration = {
            serviceWorker: "/serviceWorker.min.js", fallback: function fallback(t) {
            }
          };
        }
        ...
        _createClass(Push, [{
          ...
          value: function _closeNotification(t) {
            ...
            if (void 0 !== e) {
              if (i = this._removeNotification(t), this._agents.desktop.isSupported()) this._agents.desktop.close(e); else if (this._agents.webkit.isSupported()) this._agents.webkit.close(e); else {
                if (!this._agents.ms.isSupported()) throw i = !1, new Error(_Messages2.default.errors.unknown_interface);
          ...
          value: function _addNotification(t) {
            ...
            return this._notifications[i] = t, this._currentId++, i;
          }
        }, {
          key: "_removeNotification",
          value: function _removeNotification(t) {
            var i = !1;
            return this._notifications.hasOwnProperty(t) && (delete this._notifications[t], i = !0), i;
          }
        }, {
          ...
          value: function _serviceWorkerCallback(t, i, e) {
            ...
            var s = this._addNotification(t[t.length - 1]);
            navigator.serviceWorker.addEventListener("message", function (t) {
              var i = JSON.parse(t.data);
              "close" === i.action && Number.isInteger(i.id) && _this2._removeNotification(i.id);
          ...
          value: function _createCallback(t, i, e) {
            ...
            } else this._agents.webkit.isSupported() ? o = this._agents.webkit.create(t, i) : this._agents.firefox.isSupported() ? this._agents.firefox.create(t, i) : this._agents.ms.isSupported() ? o = this._agents.ms.create(t, i) : (i.title = t, this.config().fallback(i));
            if (null !== o) {
              var _t = this._addNotification(o),
                _n = this._prepareNotification(_t, i);
              _Util2.default.isFunction(i.onShow) && o.addEventListener("show", i.onShow), _Util2.default.isFunction(i.onError) && o.addEventListener("error", i.onError), _Util2.default.isFunction(i.onClick) && o.addEventListener("click", i.onClick), o.addEventListener("close", function () {
                s(_t);
          ...
          value: function create(t, i) {
            ...
            var e = void 0;
            if (!_Util2.default.isString(t)) throw new Error(_Messages2.default.errors.invalid_title);
            return e = this.Permission.has() ? function (e, s) {
              try {
          ...
          value: function extend(t) {
            var i,
              e = {}.hasOwnProperty;
            if (!e.call(t, "plugin")) throw new Error(_Messages2.default.errors.invalid_plugin);
            e.call(t, "config") && _Util2.default.isObject(t.config) && null !== t.config && this.config(t.config), i = new (0, t.plugin)(this.config());
            for (var s in i) {
        ...
        _createClass(DesktopAgent, [{
          ...
          value: function create(t, i) {
            return new this._win.Notification(t, {
              icon: _Util2.default.isString(i.icon) || _Util2.default.isUndefined(i.icon) ? i.icon : i.icon.x32,
              body: i.body,
              tag: i.tag,
          ...
          value: function create(t, e, i, o, r) {
            ...
            this._win.navigator.serviceWorker.register(o), this._win.navigator.serviceWorker.ready.then(function (o) {
              var n = {
                ...
                onClick: _Util2.default.isFunction(i.onClick) ? _this2.getFunctionBody(i.onClick) : "",
                onClose: _Util2.default.isFunction(i.onClose) ? _this2.getFunctionBody(i.onClose) : ""
              };
              void 0 !== i.data && null !== i.data && (n = Object.assign(n, i.data)), o.showNotification(e, {
                icon: i.icon,
                body: i.body,
                vibrate: i.vibrate,
                tag: i.tag,
      ...
      var MobileFirefoxAgent = function (_AbstractAgent) {
        ...
        _createClass(MobileFirefoxAgent, [{
          ...
          key: "create",
          value: function create(t, i) {
            var o = this._win.navigator.mozNotification.createNotification(t, i.body, i.icon);
            return o.show(), o;
          }
        }]);
      ...
      var WebKitAgent = function (_AbstractAgent) {
        ...
        _createClass(WebKitAgent, [{
          ...
          value: function create(t, e) {
            var i = this._win.webkitNotifications.createNotification(e.icon, t, e.body);
            return i.show(), i;
          }
        }, {
          key: "close",
