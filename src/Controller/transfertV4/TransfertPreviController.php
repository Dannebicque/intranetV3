...
class TransfertPreviController extends AbstractController
{
    ...
    ): Response
    {
        ...
        $previsionnels = $previsionnelRepository->findByTypeMatiereWithPagination('matiere', $page, $limit, 2025);
    ...
    ): Response
    {
        ...
        $previsionnels = $previsionnelRepository->findByTypeMatiereWithPagination('ressource', $page, $limit, 2025);
    ...
    ): Response
    {
        ...
        $previsionnels = $previsionnelRepository->findByTypeMatiereWithPagination('sae', $page, $limit, 2025);
