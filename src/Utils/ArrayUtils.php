 ...
 * @file /Users/davidannebicque/htdocs/intranetV3/src/Utils/ArrayUtils.php
 * @author davidannebicque
 * @project intranetV3
 * @lastUpdate 23/05/2021 14:21
 */

// Source originale : https://github.com/acantepie/umbrella-corebundle
...
class ArrayUtils
{
    ...
    private static function map_recursive_nested_array(
        $a,
        string $currentNs = '',
        array $stopRules = [],
        array &$result
