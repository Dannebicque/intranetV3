 ...
 */
final class Version20190329115516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE salle_examen (id INT AUTO_INCREMENT NOT NULL, salle_id INT DEFAULT NULL, formation_id INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, nb_colonnes INT NOT NULL, nb_rangs INT NOT NULL, capacite INT NOT NULL, places_interdites VARCHAR(255) NOT NULL, INDEX IDX_65CF5313DC304035 (salle_id), INDEX IDX_65CF53135200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE diplome (id INT AUTO_INCREMENT NOT NULL, responsable_diplome_id INT DEFAULT NULL, assistant_diplome_id INT DEFAULT NULL, type_diplome_id INT DEFAULT NULL, formation_id INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, libelle VARCHAR(255) NOT NULL, opt_nb_jours_saisie INT NOT NULL, opt_dilpome_decale TINYINT(1) NOT NULL, opt_suppr_absence TINYINT(1) NOT NULL, opt_methode_calcul VARCHAR(10) NOT NULL, opt_anonymat TINYINT(1) NOT NULL, opt_commentaires_releve TINYINT(1) NOT NULL, opt_espace_perso_visible TINYINT(1) NOT NULL, volume_horaire INT NOT NULL, code_celcat_departement INT NOT NULL, sigle VARCHAR(40) NOT NULL, actif TINYINT(1) NOT NULL, annee_universitaire INT NOT NULL, code_apogee VARCHAR(20) NOT NULL, code_version VARCHAR(10) NOT NULL, code_departement VARCHAR(10) NOT NULL, INDEX IDX_EB4C4D4ED2D1AAE2 (responsable_diplome_id), INDEX IDX_EB4C4D4E39A24FD8 (assistant_diplome_id), INDEX IDX_EB4C4D4E3BFB8FC7 (type_diplome_id), INDEX IDX_EB4C4D4E5200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ufr (id INT AUTO_INCREMENT NOT NULL, responsable_id INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_20D7AF9853C59D72 (responsable_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_materiel (id INT AUTO_INCREMENT NOT NULL, formation_id INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, libelle VARCHAR(100) NOT NULL, INDEX IDX_D52D976D5200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE hrs (id INT AUTO_INCREMENT NOT NULL, semestre_id INT DEFAULT NULL, diplome_id INT DEFAULT NULL, personnel_id INT DEFAULT NULL, type_hrs_id INT DEFAULT NULL, formation_id INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, nb_heures_td DOUBLE PRECISION NOT NULL, libelle VARCHAR(150) NOT NULL, annee INT NOT NULL, INDEX IDX_6D8078785577AFDB (semestre_id), INDEX IDX_6D80787826F859E2 (diplome_id), INDEX IDX_6D8078781C109075 (personnel_id), INDEX IDX_6D807878152AE753 (type_hrs_id), INDEX IDX_6D8078785200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, site_id INT DEFAULT NULL, respri_id INT DEFAULT NULL, annee_universitaire_prepare_id INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', libelle VARCHAR(255) NOT NULL, logo_name VARCHAR(50) NOT NULL, tel_contact VARCHAR(16) DEFAULT NULL, fax VARCHAR(16) DEFAULT NULL, couleur VARCHAR(16) DEFAULT NULL, site_web VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, opt_update_celcat TINYINT(1) NOT NULL, opt_agence TINYINT(1) NOT NULL, opt_materiel TINYINT(1) NOT NULL, opt_edt TINYINT(1) NOT NULL, opt_stage TINYINT(1) NOT NULL, opt_synthese TINYINT(1) NOT NULL, opt_messagerie TINYINT(1) NOT NULL, opt_infos TINYINT(1) NOT NULL, opt_annee_previsionnel INT NOT NULL, actif TINYINT(1) NOT NULL, preparation_annee TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_404021BFD17F50A6 (uuid), INDEX IDX_404021BFF6BD1646 (site_id), INDEX IDX_404021BF2AC98151 (respri_id), INDEX IDX_404021BFEB0464C9 (annee_universitaire_prepare_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE personnel (id INT AUTO_INCREMENT NOT NULL, adresse_id INT DEFAULT NULL, photo_name VARCHAR(50) NOT NULL, roles LONGTEXT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, statut VARCHAR(10) NOT NULL, poste_interne VARCHAR(10) DEFAULT NULL, tel_bureau VARCHAR(20) DEFAULT NULL, responsabilites LONGTEXT DEFAULT NULL, domaines LONGTEXT DEFAULT NULL, entreprise VARCHAR(255) DEFAULT NULL, bureau1 VARCHAR(20) DEFAULT NULL, bureau2 VARCHAR(20) DEFAULT NULL, numero_harpege INT DEFAULT NULL, initiales VARCHAR(10) DEFAULT NULL, cv_name VARCHAR(50) DEFAULT NULL, nb_heures_service DOUBLE PRECISION NOT NULL, deleted TINYINT(1) NOT NULL, couleur VARCHAR(20) DEFAULT NULL, username VARCHAR(75) NOT NULL, password VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, type_user VARCHAR(75) NOT NULL, nom VARCHAR(75) NOT NULL, prenom VARCHAR(75) NOT NULL, mail_univ VARCHAR(255) NOT NULL, site_univ VARCHAR(255) DEFAULT NULL, mail_perso VARCHAR(255) DEFAULT NULL, site_perso VARCHAR(255) DEFAULT NULL, civilite VARCHAR(3) DEFAULT \'M.\' NOT NULL, date_naissance DATE DEFAULT NULL, tel1 VARCHAR(20) DEFAULT NULL, tel2 VARCHAR(20) DEFAULT NULL, remarque LONGTEXT DEFAULT NULL, signature LONGTEXT DEFAULT NULL, visible TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_A6BCF3DE989D9B62 (slug), UNIQUE INDEX UNIQ_A6BCF3DE9FCEFE16 (mail_univ), UNIQUE INDEX UNIQ_A6BCF3DE4DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE salle_examen ADD CONSTRAINT FK_65CF53135200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
        ...
        $this->addSql('ALTER TABLE type_materiel ADD CONSTRAINT FK_D52D976D5200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
        ...
        $this->addSql('ALTER TABLE hrs ADD CONSTRAINT FK_6D8078785200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
        ...
        $this->addSql('ALTER TABLE materiel_pret ADD CONSTRAINT FK_F2CBA05F5200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE salle_examen DROP FOREIGN KEY FK_65CF53135200282E');
        ...
        $this->addSql('ALTER TABLE type_materiel DROP FOREIGN KEY FK_D52D976D5200282E');
        ...
        $this->addSql('ALTER TABLE hrs DROP FOREIGN KEY FK_6D8078785200282E');
        $this->addSql('ALTER TABLE date DROP FOREIGN KEY FK_AA9E377A5200282E');
        $this->addSql('ALTER TABLE creneau_cours DROP FOREIGN KEY FK_E844BB215200282E');
        $this->addSql('ALTER TABLE materiel_pret DROP FOREIGN KEY FK_F2CBA05F5200282E');
