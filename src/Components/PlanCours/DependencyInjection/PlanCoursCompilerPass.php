...
namespace App\Components\PlanCours\DependencyInjection;
...
class PlanCoursCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        $registry = $container->getDefinition(PlanCoursRegistry::class);
        $this->addToRegistry($container, $registry, PlanCoursRegistry::TAG_PLAN_COURS, 'registerPlanCours');
    }
